...
export class TopologicalSort {
  ...
  initAdList(){
    this.adList.push(new VertexNode(0,"v0",new EdgeNode("v11",new EdgeNode("v5",new EdgeNode("v4",null)))));
    this.adList.push(new VertexNode(0,"v1",new EdgeNode("v8",new EdgeNode("v4",new EdgeNode("v2",null)))));
    this.adList.push(new VertexNode(2,"v2",new EdgeNode("v9",new EdgeNode("v6",new EdgeNode("v5",null)))));
    this.adList.push(new VertexNode(0,"v3",new EdgeNode("v13",new EdgeNode("v2",null))));
    this.adList.push(new VertexNode(2,"v4",new EdgeNode("v7",null)));
    this.adList.push(new VertexNode(3,"v5",new EdgeNode("v12",new EdgeNode("v8",null))));
    ...
    this.adList.push(new VertexNode(1,"v9",new EdgeNode("v11",new EdgeNode("v10",null))));
  ...
  sort(){
    ...
    while (this.stack.length!==0){
      ...
      while (edge){// iterate all related edge's inCount --
        const index = this.adList.findIndex(item=>item.name === edge.name);
