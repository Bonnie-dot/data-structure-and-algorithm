...
describe('Queue operating', () => {
    test('should enqueue successfully when call enqueue without full', () => {
    ...
    test('should enqueue fail when array is fill', () => {
    ...
    test('should dequeue successfully when call dequeue without full', () => {
    ...
    test('should dequeue fail when array is empty', () => {
        const queue = new Queue(2);
